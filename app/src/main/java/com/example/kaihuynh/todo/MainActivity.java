...
public class MainActivity extends AppCompatActivity {
    ...
    private ListView mTodayListView, mTomorrowListView, mUpcomingListView;
    private ArrayList<Todo> mTodayList, mTomorrowList, mUpcomingList;
    private ArrayAdapter<Todo> mTodayAdapter, mTomorrowAdapter, mUpcomingAdapter;
